...
|2     |订单号   |PREORDERNO|VARCHAR(20)|Y            |电商平台的原始订单号，同一个电商企业的订单编号要唯一|
...
|8       |收货人身份证号|CONSIGNEEID|varchar(50)  |Y    |进口订单填收货人身份证号|
|9       |收件身份    |receiveprovince|varchar(40)|Y    |收件省份|
|10      |收件城市|receivecity|varchar(40)|Y    |收件城市|
|11      |收件地区|receivearea|varchar(40)|Y    |收件地区|
|12      |收件地址|CONSIGNEE_ADDRESS|varchar(255)|Y   |收件地址|
|13    |收件人电话|CONSIGNEE_TELEPHONE|varchar(50)|Y  |收件人电话|
|14    |物流企业电话|LogisticsCode|varchar(10)|Y   |申报单位代码。十位海关代码|
|15    |物流企业名称|LogisticsName|VARCHAR(255)|Y  |申报企业名称|
|16    |订单GUID| ORDERID|  varchar(32)|Y    |订单GUID|
|17    |总件数 |ToTAL_COUNT|numeric(18,2)|Y   |总件数|
...
|----|--------|--------|--------|--------|----|
|1   |商品SKU|itemno|varchar(20)|Y    |商品SKU|
...
|10  |付款人代码|DraweeIdentity|varchar(18)|N  |付款人的代码。进口支付单信息填支付人的身份证号|
...
|序号|字段名称|字段代码|数据类型|是否必填|备注|
|----|--------|--------|--------|--------|----|
|1  |运单编号|logisticsno|varchar(20)|Y   |物流企业派送时每个物流面单编号|
...
|  版本号|  更新时间     |   更新内容                                        |  备 注  
||:------:|:-------------:|:-------------------------------------------------:|:---------:|
|1.1     |2016-07-01|订单增加了运单号：logisticsno，物流企业代码：LogisticsCode，物流企业名称：LogisticsName:|                     |
